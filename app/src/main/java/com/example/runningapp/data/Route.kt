...
interface RouteDao {
     ...
     * rows ([SessionRepository.payWhatRunShapesOwe]). Paying it here, or waiting on it, would stall
     * the page for as long as the history is long; a landing that ignores a Run still being
     * measured is right again the next time the family is opened, and the length wanted is one tap
     * away. Decided with Chris on 2026-09-08 while closing #440.
     */
