...
/**
 * One route, many lengths (#421) — the folding and the words.
 *
 * Every claim here is one a runner can see: how many rows the library has and what the row says.
 * Nothing about the table. Which length a page opens on is the library's rule, pinned by
 * `RouteFamilyTest` and `RouteLibraryTest` (#480).
 */
