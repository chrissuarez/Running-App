...
- **Training Plan & AI Coach**:
    ...
    - **Graduating**: A Stage asks for something before it will let go of you. Where it is written in
      ...
      judgement to a separate AI judge, one question about the Stage's training as a whole
      (ADR 0023, ADR 0024) — one and not one per run, because no single run shows four weeks of
      anything.
